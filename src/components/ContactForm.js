      ...
      <h3 id="emailKO" className="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white hidden">Ha ocurrido un error, no se ha podido enviar el correo.</h3>
        <form method="POST" onSubmit={handleSubmit} className="space-y-8">
          ...
          <button
            id="submit"
            type="submit"
            className="py-3 px-5 text-sm font-medium text-center text-gray-900 bg-gray-50 rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
          >
            Enviar
          </button>
        </form>
