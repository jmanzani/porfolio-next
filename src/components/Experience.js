...
export default function Experience() {
  const experiences = [
    ...
    },
    {
      ...
      description: "Proyecto de aplicación Windows utilizando WinUI 3, C#, Entity Framework y SQL para el cliente y mantenimiento de aplicacion Web ASP.NET. Además se atienden soportes de los clientes."
    }
